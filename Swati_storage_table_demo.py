...
resourcegroup_name = 'syen'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'syen'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'eastus'
...
pizza.PartitionKey = 'pizzamenu'
pizza.RowKey = '004'
pizza.description = 'Chicken'
pizza.cost = 12
table_service.insert_entity('itemstable', pizza)
print('Created entry for Chicken...\n')
...
print('Created entry for Honda CRV...')
...
Coffeeshop.size = 'Tall'
Coffeeshop.price = '$6.75'
...
Coffeeshop.brand = 'Folgers'
Coffeeshop.flavor = 'Espresso'
Coffeeshop.size = 'Medium'
Coffeeshop.price = '$5.75'
table_service.insert_entity('itemstable', Coffeeshop)
print('Created entry for Folgers Espresso...')
